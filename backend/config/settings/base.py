...
# ---------------------------------------------------------------------------
# Email  (SMTP — paramétré via variables d'environnement)
# En développement, development.py utilise ConsoleEmailBackend à la place.
# ---------------------------------------------------------------------------
...
DEFAULT_FROM_EMAIL  = env("DEFAULT_FROM_EMAIL",  default="GestFiches <noreply@jbesion.local>")

# URL du frontend, ajoutée en pied des e-mails de notification
